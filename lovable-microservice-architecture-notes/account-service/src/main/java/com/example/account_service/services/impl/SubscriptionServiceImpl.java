...
import com.example.account_service.mapper.SubscriptionMapper;
import com.example.account_service.repository.PlanRepository;
import com.example.account_service.repository.SubscriptionRepository;
...
//    private final ProjectMemberRepository projectMemberRepository;
    ...
    private final Integer FREE_TIER_MAX_PROJECTS_ALLOWED = 100;
...
//    }
    ...
    public PlanDto getCurrentSubscribedPlanByUser() {
        SubscriptionResponse subscriptionResponse = getCurrentSubscription(authUtil.getCurrentUserId());
