package com.example.common_lib.security;
...
public class AuthUtil {
    ...
    public JwtUserPrincipal verifyAccessToken(String token) {
        Claims claims = Jwts.parser()
                .verifyWith(getSecretKey()) // This tells JJWT what key to verify against
                .build()                   // Builds the JwtParser
                .parseSignedClaims(token)     // This actually parses AND verifies the signature
                .getPayload();
